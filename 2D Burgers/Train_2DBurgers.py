...
#############################
####### SAVE FOR U ##########
torch.save({'encoder_state_dict': encoder.state_dict(), 'decoder_state_dict': decoder.state_dict()}, './model/AE_u_git.tar')
#############################
#############################
...
torch.save({'encoder_state_dict': encoder.state_dict(), 'decoder_state_dict': decoder.state_dict()}, './model/AE_v_git.tar')

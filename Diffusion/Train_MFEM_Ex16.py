...
#         plt.show()
    ...
    nxy = 64**2
    training_rad = np.arange(20,540,80) 
    training_iv = np.arange(180,228,20)
...
#     plt.title('Original $u$')
    ...
    encoder = encoder
    decoder = decoder
    torch.save({'encoder_state_dict': encoder.state_dict(), 'decoder_state_dict': decoder.state_dict()}, '../../../../../usr/WS1/fries4/Experiments/EX16/model/ex16_AE_full21_{}dim.tar'.format(LS_dim))
